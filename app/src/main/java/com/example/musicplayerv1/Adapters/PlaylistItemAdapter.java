...
public class PlaylistItemAdapter extends RecyclerView.Adapter<PlaylistItemAdapter.TrackHolder> {
    Context context;
    ArrayList<Track> tracks;
    IItemPlaylisClick iItemPlaylisClick;
    public PlaylistItemAdapter(Context context, ArrayList<Track> tracks, IItemPlaylisClick iItemPlaylisClick){
